...
resetprop_and_write ro.build.id AP3A.240905.015.A2
resetprop_and_write ro.build.version.incremental S938BXXU1AYB4
...
for prefix in "" bootimage system product odm system_ext; do
    ...
    resetprop_and_write "${product_prefix}.brand" samsung
    resetprop_and_write "${product_prefix}.name" pa3qxxx
    resetprop_and_write "${product_prefix}.device" pa3q
    resetprop_and_write "${product_prefix}.model" SM-S938B
    resetprop_and_write "${product_prefix}.manufacturer" samsung

    resetprop_and_write "${product_prefix}.brand_for_attestation" samsung
    resetprop_and_write "${product_prefix}.name_for_attestation" pa3qxxx
    resetprop_and_write "${product_prefix}.device_for_attestation" pa3q
    resetprop_and_write "${product_prefix}.model_for_attestation" SM-S938B
    resetprop_and_write "${product_prefix}.manufacturer_for_attestation" samsung
done
