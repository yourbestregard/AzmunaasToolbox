...
resetprop_and_write ro.build.id AP3A.241005.015.A2
resetprop_and_write ro.build.version.incremental 12426170
...
for prefix in "" bootimage system product odm system_ext; do
    ...
    resetprop_and_write "${product_prefix}.brand" google
    resetprop_and_write "${product_prefix}.name" mainline
    resetprop_and_write "${product_prefix}.device" generic
    resetprop_and_write "${product_prefix}.model" mainline
    resetprop_and_write "${product_prefix}.manufacturer" google

    resetprop_and_write "${product_prefix}.brand_for_attestation" google
    resetprop_and_write "${product_prefix}.name_for_attestation" mainline
    resetprop_and_write "${product_prefix}.device_for_attestation" generic
    resetprop_and_write "${product_prefix}.model_for_attestation" mainline
    resetprop_and_write "${product_prefix}.manufacturer_for_attestation" google
done
